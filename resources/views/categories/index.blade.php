                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-center">Imagen portada</th>
                                <th class="py-3 px-6 text-center">Estatus</th>
                                <th class="py-3 px-6 text-center">Creador</th>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @foreach ($data as $key => $category)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center item-center justify-center">
                                        <!--<span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">Active</span>-->
                                        <img class="w-auto h-14 rounded-sm border-gray-200 border transform hover:scale-125"
                                            src="/storage/image/{{ $category->image }}">
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <!--<span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">Active</span>-->
                                        <span
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <!--<span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">Active</span>-->
                                        <span>User id: {{ $category->user_id }}</span>
                                    </td>
                                    <td class="py-3 px-6 text-center">
